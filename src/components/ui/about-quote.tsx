        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы — ИИ-студия нового поколения. Создаём комиксы, видео и контент для брендов, авторов и бизнеса. ИИ делает тяжёлую работу — вы получаете результат быстро и с характером.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Неважно, нужен ли вам один ролик или целая серия комиксов — мы воплотим вашу идею в жизнь. Без долгих согласований, без раздутых команд. Только идея, ИИ и готовый контент.
            </p>
          </div>
        </div>
      </div>
